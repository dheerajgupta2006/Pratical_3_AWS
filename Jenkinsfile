pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://13.49.80.41:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/dheerajgupta2006/Pratical_3_AWS.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://13.49.80.41:9090/springapp1"
            echo "✅ Frontend deployed: http://13.49.80.41:9090/frontapp1"
        }
        failure {
